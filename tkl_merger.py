...
def save_tkl(boss_tkl_in_path, dir_out, tkl_ref, loc_lut, rot_lut):
	with open(boss_tkl_in_path, 'rb') as f:
		tklstream = f.read()
...
def work(tmd_paths, dir_out, boss_tkl):

	print("boss_tkl:",boss_tkl)
	tkl_to_luts = {}
	tmd_to_keys={}
	boss_tkl_in_path = None
	for tmd_path in tmd_paths:
	...
	save_tkl( boss_tkl_in_path, dir_out, boss_tkl, final_locs_lut, final_rots_lut)
